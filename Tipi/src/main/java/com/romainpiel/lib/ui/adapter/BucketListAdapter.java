        ...
        for (int i = (bucketPosition * bucketSize); i < ((bucketPosition * bucketSize) + bucketSize); i++) {
            ...
            if (j < bucket.getChildCount()) {
                ...
                if (i < super.getCount()) {
                    ...
                    getBucketElement(i, getItem(i), currentConvertView);
                ...
                bucketElementFrame.setLayoutParams(new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.MATCH_PARENT, 1));
